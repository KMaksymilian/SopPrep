Miejsce zajęte w 95% … Jeśli zabraknie Ci miejsca, stracisz możliwość tworzenia i edytowania plików, a także ich przesyłania. Zyskaj 100 GB miejsca na dane przez 1 miesiąc za 8,99 zł 2,25 zł (cena przygotowana specjalnie dla Ciebie).
#define _GNU_SOURCE
#include <dirent.h>
#include <errno.h>
#include <fcntl.h>
